...
const inkTheme: ThemePresetConfig = {
  ...
  colors: {
    light: {
      ...
      sidebarBackground: "hsl(220 20% 96%)",
      sidebarBorder: "hsl(220 14% 88%)",
      sidebarActiveBackground: "hsl(220 16% 92%)",
      headerBackground: "hsl(220 20% 99% / 0.88)",
    ...
    dark: {
      ...
      backgroundSubtle: "hsl(228 8% 7%)",
      muted: "hsl(228 6% 12%)",
      mutedForeground: "hsl(220 10% 56%)",
      border: "hsl(228 6% 15%)",
      borderSubtle: "hsl(228 6% 11%)",
      accent: "hsl(228 6% 13%)",
      accentForeground: "hsl(210 22% 95%)",
      codeBackground: "hsl(228 12% 3%)",
      codeForeground: "hsl(220 16% 89%)",
      codeHighlight: "hsl(228 6% 11%)",
      sidebarBackground: "hsl(228 10% 4%)",
      sidebarBorder: "hsl(228 6% 13%)",
      sidebarActiveBackground: "hsl(228 6% 13%)",
      headerBackground: "hsl(228 10% 4% / 0.88)",
      headerBorder: "hsl(228 6% 13%)",
    },
  },
  typography: {
  ...
  effects: {
    ...
    shadowLg: "0 10px 15px -3px rgb(0 0 0 / 0.08), 0 4px 6px -4px rgb(0 0 0 / 0.03)",
    radiusSm: "0.375rem",
    radiusMd: "0.5rem",
    radiusLg: "0.75rem",
    headerBlur: "16px",
...
const auroraTheme: ThemePresetConfig = {
  ...
  colors: {
    light: {
      ...
      codeBackground: "hsl(240 20% 96%)",
      codeForeground: "hsl(240 24% 10%)",
      codeHighlight: "hsl(240 18% 92%)",
...
const verdantTheme: ThemePresetConfig = {
  ...
  colors: {
    light: {
      ...
      codeBackground: "hsl(48 30% 94%)",
      codeForeground: "hsl(160 20% 12%)",
      codeHighlight: "hsl(48 25% 90%)",
...
const emberTheme: ThemePresetConfig = {
  ...
  colors: {
    light: {
      ...
      codeBackground: "hsl(36 25% 94%)",
      codeForeground: "hsl(20 20% 12%)",
      codeHighlight: "hsl(34 20% 90%)",
...
const midnightTheme: ThemePresetConfig = {
  ...
  colors: {
    light: {
      ...
      codeBackground: "hsl(215 22% 96%)",
      codeForeground: "hsl(218 30% 12%)",
      codeHighlight: "hsl(215 18% 92%)",
...
const duneTheme: ThemePresetConfig = {
  ...
  colors: {
    light: {
      ...
      codeBackground: "hsl(330 14% 96%)",
      codeForeground: "hsl(335 15% 13%)",
      codeHighlight: "hsl(330 12% 92%)",
...
const fossilTheme: ThemePresetConfig = {
  ...
  colors: {
    light: {
      ...
      codeBackground: "hsl(0 0% 94%)",
      codeForeground: "hsl(0 0% 11%)",
      codeHighlight: "hsl(0 0% 90%)",
...
const vaporTheme: ThemePresetConfig = {
  ...
  colors: {
    light: {
      primary: "hsl(0 0% 100%)",
      primaryForeground: "hsl(195 25% 12%)",
      ...
      accentForeground: "hsl(195 25% 12%)",
      codeBackground: "hsl(190 18% 96%)",
      codeForeground: "hsl(195 25% 12%)",
      codeHighlight: "hsl(190 14% 92%)",
    ...
    dark: {
      primary: "hsl(0 0% 100%)",
      primaryForeground: "hsl(200 18% 6%)",
      ...
      accentForeground: "hsl(190 15% 92%)",
...
const aubergineTheme: ThemePresetConfig = {
  ...
  colors: {
    light: {
      ...
      codeBackground: "hsl(278 12% 96%)",
      codeForeground: "hsl(275 18% 14%)",
      codeHighlight: "hsl(276 10% 92%)",
...
// Re-exported from color-utils for backward compatibility
export { computeContrastForeground } from "./color-utils";
