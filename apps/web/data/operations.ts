...
export const api = {
  ...
  projects: {
    list: defineQuery("projects.list", (_client, _input: undefined) =>
      _client.projects.list()
    ),
    ...
    get: defineQuery("projects.get", (_client, input: { projectId: string }) =>
      _client.projects.get(input.projectId)
    ),
    ...
    remove: defineMutation(
      ...
      (client, input: { projectId: string }) =>
        client.projects.remove(input.projectId)
    ),
