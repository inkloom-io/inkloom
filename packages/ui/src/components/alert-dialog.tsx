...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    ...
    {...{ className: cn(
      ...
      className
    ), ...props } as React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Overlay>}
  />
));
  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      {...{ className: cn(
        ...
        className
      ), ...props } as React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Content>}
    />
  </AlertDialogPortal>
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    {...{ className: cn("text-lg font-semibold", className), ...props } as React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Title>}
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    ref={ref}
    {...{ className: cn("text-sm text-muted-foreground", className), ...props } as React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Description>}
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ...
    {...{ className: cn(
      ...
      className
    ), ...props } as React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Action>}
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    {...{ className: cn(
      ...
      className
    ), ...props } as React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Cancel>}
  />
));
